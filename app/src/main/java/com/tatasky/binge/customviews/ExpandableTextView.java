...
final public class ExpandableTextView extends androidx.appcompat.widget.AppCompatTextView{
    ...
    private static final int TO_EXPAND_HINT_COLOR = 0xFFE10092;//E10092
    private static final int TO_SHRINK_HINT_COLOR = 0xFFE74C3C;//E10092
        ...
        switch (mCurrState){
            case STATE_SHRINK: {
                ...
                if (mShowToExpandHint) {
                    ...
                    // Added extra span for more button during CT integration
                    ssbShrink.setSpan(new RoundedBackgroundSpan(getContext()), ssbShrink.length() - getLengthOfString(mToExpandHint), ssbShrink.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                }
                return ssbShrink;
            }
            case STATE_EXPAND: {
                ...
                ssbExpand.setSpan(new RoundedBackgroundSpan(getContext()), ssbExpand.length() - getLengthOfString(mToShrinkHint), ssbExpand.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                return ssbExpand;
                // Added extra span for more button during CT integration
