    ...
    val appSignatures: ArrayList<String>
        ...
        get() {
            ...
            try {
                ...
                com.tatasky.binge.utils.e(TAG, "$e Unable to find package to obtain hash.")
            }
            return appCodes
        }
    ...
    companion object {
        ...
        private fun hash(packageName: String, signature: String): String? {
            ...
            try {
                ...
                d(TAG + "sms_sample_test", String.format("pkg: %s -- hash: %s", packageName, base64Hash))
                return base64Hash
            } catch (e: NoSuchAlgorithmException) {
                com.tatasky.binge.utils.e(TAG + "sms_sample_test", "$e hash:NoSuchAlgorithm")
            }
            return null
        }
    }
