...
import com.ttn.ttnplayer.util.UtilityKt;
 ...
 */
public class TtnTrackSelectionView extends LinearLayout {
    ...
    private TtnTrackNameProvider trackNameProvider;
     ...
     * Creates a track selection view.
     */
    public TtnTrackSelectionView(Context context, @Nullable AttributeSet attrs) {
    ...
    public TtnTrackSelectionView(
        ...
        trackNameProvider = new TtnTrackNameProvider(getResources());
        trackGroups = TrackGroupArray.EMPTY;

        // View for disabling the renderer.
        disableView =
                (CheckedTextView)
                        inflater.inflate(R.layout.single_choice_item, this, false);
//        disableView.setBackgroundResource(selectableItemBackgroundResourceId);
        ...
        addView(disableView);
        // Divider view.
//        addView(inflater.inflate(R.layout.single_choice_item_divider, this, false));
...
//        defaultView.setBackgroundResource(selectableItemBackgroundResourceId);
    ...
    void addTitle(String title) {
        if (title != null && !title.isEmpty()) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                titleTextView.setTextAppearance(R.style.TrackTitleText);
            } else {
        ...
        /*if (getChildCount() <= 0) {
            throw RuntimeException("Cannot add title: view child count is 0 or less")
        }*/
     ...
     */
    public void setTrackNameProvider(TtnTrackNameProvider trackNameProvider) {
    ...
    private void updateViews() {
        ...
        for (int groupIndex = 0; groupIndex < trackGroups.length; groupIndex++) {
            ...
            for (int trackIndex = 0; trackIndex < group.length; trackIndex++) {
                ...
                String text = trackNameProvider.getTrackName(group.getFormat(trackIndex));
...
//                trackView.setBackgroundResource(selectableItemBackgroundResourceId);
                if(rendererIndex == TtnPlayerHelper.VIDEO_TRACK) {
                    trackView.setText(String.format("%sp", text));
                } else {
    ...
    private class ComponentListener implements OnClickListener {
        ...
        public void onClick(View view) {
            TtnTrackSelectionView.this.onClick(view);
        }
    }
}
