...
import kotlinx.android.synthetic.main.activity_device_list_management.*

class DeviceListManagementActivity : BaseActivity<CommonSampleViewModel>() {
    override fun getContentViewId(): Int = R.layout.activity_device_list_management
    ...
    companion object{
        const val DEVICE_LIMIT_REQUEST_CODE = 1201
        const val KEY_TEMP_BAID = "tempBaid" /*Target BAID of which to list devices*/
        const val KEY_IS_DEVICE_REVIEW_ON_MAX_LIMIT_REACHED = "isDeviceReviewOnMaxLimitReached"
    }
